...
plot(heartbeat@left, type='n', main='Channel 1 + Channel 2', xlab='Time', ylab='Frequency')
lines(heartbeat@left)
```

I multiply the 10 beats with 12 to find the heart rate: `r 10 *12` bpm! Sounds plausible. If you're interested in deeper analysis of the sound file, you'll find more information in the book.
